...
import org.lexevs.dao.index.operation.SourceAssertedVSTest;
...
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.AddTargetToExistingSourceTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.CreateAssociationTargetTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.CreateNewAssociationDataTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.CreateNewAssociationSourceWithTargetTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.GetAssociationQualifiersTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.MrMapProcessorTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.MrMapReaderTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.ProcessMrSatRowTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.ProcessMrSatToRelationsTest;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.TestLoadMrMap2Mappings;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.TestMRMapResolveGraphOnly;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.TestManifestBreakDown;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.TestManifestSetup;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.TestMapParse;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.TestMrMapMappingResolution;
import edu.mayo.informatics.lexgrid.convert.directConversions.mrmap.TestRemoveMrMap2Loads;
...
public class AllTestsMonoLoad {
    ...
    public static Test suite() throws Exception {
     ...
     // TODO comment in when the loaders are fixed
...
//        mainSuite.addTestSuite(TestManifestSetup.class);
...
//        functionalTests.addTestSuite(TestPreLoadManifest.class);
     ...
     // TODO comment in when the loaders are fixed
        ...
        TestSuite mrMapAllTests = new TestSuite("MrMapTests");
        mrMapAllTests.addTestSuite(AddTargetToExistingSourceTest.class);
        mrMapAllTests.addTestSuite(CreateAssociationTargetTest.class);
        mrMapAllTests.addTestSuite(CreateNewAssociationDataTest .class);
        mrMapAllTests.addTestSuite(CreateNewAssociationSourceWithTargetTest.class);
        mrMapAllTests.addTestSuite(GetAssociationQualifiersTest.class);
        mrMapAllTests.addTestSuite(MrMapProcessorTest.class);
        mrMapAllTests.addTestSuite(MrMapReaderTest.class);
        mrMapAllTests.addTestSuite(ProcessMrSatToRelationsTest.class);
        mrMapAllTests.addTestSuite(ProcessMrSatRowTest.class);
        mrMapAllTests.addTestSuite(TestMapParse.class);
    	mrMapAllTests.addTestSuite(TestMRMapResolveGraphOnly.class);
    	mrMapAllTests.addTestSuite(TestMrMapMappingResolution.class);
    	//mrMapAllTests.addTestSuite(TestManifestBreakDown.class);
        
        mainSuite.addTest(mrMapAllTests);
        //AsserteValueSets
        ...
        assertedValueSetUpdates.addTest(new JUnit4TestAdapter(SourceAssertedVSTest.class));
        assertedValueSetUpdates.addTest(orderedSuite(SourceAssertedValueSetSearchIndexServiceTest.class));
