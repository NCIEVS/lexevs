...
public class MethodCachingInterceptorTest extends LexEvsDbUnitTestBase {
	...
	public void testComplexObject() {
		...
		assertEquals(testCacheBean.getValueOfCompositeObject(ref),
		...
		assertEquals(testCacheBean.getValueOfCompositeObject(ref1),
				ref1.getCodingSchemeURN() + ref1.getCodingSchemeVersion());
		assertEquals(testCacheBean.getValueOfCompositeObject(ref1),
				ref1.getCodingSchemeURN() + ref1.getCodingSchemeVersion());
	}
	...
	public void testPutInCache() {
		...
		assertEquals("onetwo", testCacheProxy.getCacheFromName("org.lexevs.dao.test.TestCacheBeangetValue110182115276")
				.get("org.lexevs.dao.test.TestCacheBeangetValue110182115276"));
	}
	...
	public void testTwoDifferentInCache() {
		...
		assertEquals("threefour",
				testCacheProxy.getCacheFromName("org.lexevs.dao.test.TestCacheBeangetValue1103394863149094")
						.get("org.lexevs.dao.test.TestCacheBeangetValue1103394863149094"));
		assertEquals("onetwo", testCacheProxy.getCacheFromName("org.lexevs.dao.test.TestCacheBeangetValue110182115276")
				.get("org.lexevs.dao.test.TestCacheBeangetValue110182115276")); // assertEquals("threefour",
																				// testCacheProxy.getCaches().get("testCache").values().toArray()[1]);
	}
	...
	public void testUnCachableMethod() {
		...
		assertNull(testCacheProxy.getCacheFromName("org.lexevs.dao.test.TestCacheBeangetValueNotCachable110182115276"));
	}
	...
	public void testClearCache() {
		...
		assertNull(testCacheProxy.getCacheFromName("org.lexevs.dao.test.TestCacheBeangetValue110182115276")
				.get("org.lexevs.dao.test.TestCacheBeangetValue110182115276"));
		assertNull("threefour",
				testCacheProxy.getCacheFromName("org.lexevs.dao.test.TestCacheBeangetValue1103394863149094")
						.get("org.lexevs.dao.test.TestCacheBeangetValue1103394863149094"));
	}
